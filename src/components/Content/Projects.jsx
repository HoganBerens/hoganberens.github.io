    ...
    <div className="projects-wrapper">
      ...
      <div className="projects-container">
        <Link target="_blank" to="https://hogans-golf-stats-tracker-471d20cc5c65.herokuapp.com/" className="projects-description-container">
          ...
          <div className="projects-description">Golf-Stats-Tracker is a Full-Stack app built using Express, Mongoose, HTML, CSS and MongoDB. Enter your clubs and recent scores to see the good and bad of your golf game. </div>
        </Link>
