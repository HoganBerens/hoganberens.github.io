  ...
  return (
    <div className="contact-wrapper">
      ...
      <div className="contact-links-profile">
        <a className="contact-link" href="mailto:hoganmberens@gmail.com" target="_blank">
        ...
        <Link className="contact-link contact-resume" target="_blank" to="https://docs.google.com/document/d/11kGvdQ9orlkMnjX_Ve5cIR5AfOhKXXAgiTvzleVjpUY/edit?usp=sharing">
          Resume
        </Link>
      </div>
    </div>
