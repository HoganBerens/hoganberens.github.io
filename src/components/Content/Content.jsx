    ...
    <div className="content-wrapper">
      <div className="content-description-wrapper">
        ...
        <div className="content-description">
          ...
          <strong>Python, Django, JavaScript, React.js, Node.js, HTML, CSS</strong> and database management with
        ...
        <div className="content-links-wrapper">
          <a className="content-link" target="_blank" href="https://www.linkedin.com/in/hogan-berens-869523278/">
            <span>LinkedIn</span>
          </a>
          <a className="content-link" target="_blank" href="https://github.com/HoganBerens">
            <span>Github</span>
          </a>
        </div>
      </div>
